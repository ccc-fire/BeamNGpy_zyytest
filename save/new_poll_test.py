...
def poll_camera(beamng: BeamNGpy):
    with beamng as bng:
        ...
        scenario = Scenario('east_coast_usa', 'camera_test', description='Testing the camera sensor')  # Create a scenario.
        ...
        #         while(cam1.is_ad_hoc_poll_request_ready(cam1_rid)==False):
        #             sleep(0.1)
        #         print('Is ad-hoc request complete? ', cam1_rid)
        #     t1 = time.time()
        ...
        # task1.start()
        #
        # task2 = threading.Thread(target=cam1_c, args=cam1_id)
