...
def main():
    ...
    try:
        ...
        for frame_id in range(1):
            ...
            # 执行代码
            collect_camera(bird_view_camera, frame_id)
            ...
            # ___________________________________________
            # collect_camera(bird_view_camera, frame_id)
            collect_camera(camera_front, frame_id)
            collect_camera(camera_front_left, frame_id)
            collect_camera(camera_front_right, frame_id)
            collect_camera(camera_back_left, frame_id)
            collect_camera(camera_back_right, frame_id)
            collect_camera(camera_back, frame_id)
